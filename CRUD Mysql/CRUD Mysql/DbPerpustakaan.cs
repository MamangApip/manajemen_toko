...
namespace CRUD_Mysql
{
    internal class DbPerpustakaan
    {
        ...
        {
            string sql = "INSERT INTO kategori_barang VALUES (NULL, @NamaKategori, @NamaPenanggungJawab)";
        ...
        {
            string sql = "UPDATE kategori_barang SET nama_kategori = @NamaKategori, nama_penanggung_jawab = @NamaPenanggungJawab WHERE id_kategori = @KategoriID";
            MySqlConnection conn = GetConnection();
            MySqlCommand cmd = new MySqlCommand(sql, conn);
            cmd.CommandType = CommandType.Text;
        ...
        {
            string sql = "DELETE FROM kategori_barang WHERE id_kategori = @KategoriID";
            MySqlConnection conn = GetConnection();
            MySqlCommand cmd = new MySqlCommand(sql, conn);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("@KategoriID", MySqlDbType.VarChar).Value = id;
        ...
        {
            string sql = "INSERT INTO inv_buku VALUES (NULL, @JudulBuku, @KategoriBuku, @Penulis";
            MySqlConnection conn = GetConnection();
            MySqlCommand cmd = new MySqlCommand(sql, conn);
            cmd.CommandType = CommandType.Text;
        ...
        {
            string sql = "UPDATE inv_buku SET judul_buku = @JudulBuku, kategori_barang = @KategoriBuku, penulis = @Penulis WHERE id_buku = @BukuID";
            MySqlConnection conn = GetConnection();
            MySqlCommand cmd = new MySqlCommand(sql, conn);
            cmd.CommandType = CommandType.Text;
